...
namespace Latihan_2_1
{
    public partial class Form1 : Form
    {
        ...
        public void Libur()
        {
            DateTime DT1 = monthCalendar1.SelectionStart.AddMonths(-4);
            DateTime DT2 = monthCalendar1.SelectionStart.AddMonths(4);
            ...
            DateTime Date1 = Convert.ToDateTime(Day1 + "/" + Month1 + "/" + Year1);
            DateTime Date2 = Convert.ToDateTime(Day2 + "/" + Month2 + "/" + Year2);
        ...
        {
            monthCalendar1.AddAnnuallyBoldedDate(new DateTime(2016, 02, 04));
